    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('admin.vehicle.edit', $vehicle->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Vehicle Owner Name*</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" value="{{ $vehicle->vehicle_owner_name }}" class="form-control" placeholder="Vehicle Owner Name" required name="vehicle_owner_name" id="vehicle_owner_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Vehicle Number*</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" value="{{ $vehicle->vehicle_no }}" class="form-control" placeholder="Vehicle Number" required name="vehicle_no" id="vehicle_no">
                        </div>
                    </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">RC No.*</label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <input type="text" value="{{ $vehicle->rc_no }}" class="form-control" placeholder="RC No." name="rc_no" required id="rc_no">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <input type="text" value="{{ $vehicle->pollution_no }}" class="form-control" placeholder="Pollution No." required name="pollution_no" id="pollution_no">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Pollution Start Date*</label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <input type="date" value="{{ $vehicle->pllu_start_date }}" class="form-control" name="pllu_start_date" required id="pllu_start_date">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Pollution End Date*</label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <input type="date" value="{{ $vehicle->pollu_end_date }}" class="form-control" name="pollu_end_date" required id="pollu_end_date">
                    </div>
                </div>
                <div class="form-group">
