            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('admin.staff.edit', $user->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input readonly="true" value="{{ $user->mobile_number }}" type="text" class="form-control" placeholder="Mobile No." name="staff_mobile_no" id="staff_mobile_no" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input value="{{ $user->address }}" type="text" class="form-control" placeholder="Address" name="staff_address" id="staff_address" required>
                        </div>
                    </div>
