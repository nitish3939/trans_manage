    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('admin.trip.fuelView',$fuel->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group">
                        ...
                        @if($fuel->fuel_bill_image1)
                         <a href="{{$fuel->fuel_bill_image1 }}" target="_blank"><img class="img-rounded" style="width: 100px; height: 100px;" src="{{ $fuel->fuel_bill_image1 }}" ></a>@endif
                        </div>
                    </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <a  class="btn btn-default" href="{{ route('admin.trip.fuel',$fuel->trip_id) }}">Cancel</a>
