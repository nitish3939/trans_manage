    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.challan.edit', $challan->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <img  style="width: 100px; height: 100px;" src="{{ asset('storage/challan/'.$challan->challan_pic) }}" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <a  class="btn btn-default" href="{{ route('subadmin.challan.index') }}">Cancel</a>
