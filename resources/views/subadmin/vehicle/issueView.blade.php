...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.vehicle.issueView',$vehicle->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <a  class="btn btn-default" href="{{ route('subadmin.vehicle.issue',$vehicle->vehicle_id) }}">Cancel</a>
