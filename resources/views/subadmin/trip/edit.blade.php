        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.trip.edit', $trip->id) }}" method="post" id="addStaffForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <option value="{{$dri->id}}" @if($dri->id == $trip->user_id){{'selected'}}@endif>{{$dri->first_name}} {{$dri->last_name}}</option>
                            @endforeach
                            </select>
                            @endif
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                    <textarea class="form-control" rows="4" cols="50" name="start_trip" id="start_trip" required>{{ $trip->start_trip }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">End Trip*</label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                    <textarea class="form-control" rows="4" cols="50" name="end_trip" id="end_trip" required>{{ $trip->end_trip }}</textarea>
                    </div>
                </div>
                <div class="form-group">
